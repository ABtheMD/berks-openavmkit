...
class DataSplit:
    ...
    def encode_categoricals_with_one_hot(self, exceptions: list[str] = None):
        ...
        # Deduplicate columns that may collide after clean_column_names
        # (e.g. 'code.1' and 'code_1' both become 'code_1').
        ...
        ds.df_universe = _dedup_columns(ds.df_universe)
        ds.df_sales = _dedup_columns(ds.df_sales)
        ds.df_train = _dedup_columns(ds.df_train)
        ds.df_test = _dedup_columns(ds.df_test)
